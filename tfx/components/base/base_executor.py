...
class BaseExecutor(with_metaclass(abc.ABCMeta, object)):
  ...
  def __init__(self, context = None):
    ...
    self._tmp_dir = context.tmp_dir if context else None
    self._unique_id = context.unique_id if context else None
  ...
  def _get_tmp_dir(self):
    ...
    tmp_path = os.path.join(self._tmp_dir, self._unique_id, '')
