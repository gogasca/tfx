...
"""Main entrypoint for containers with Kubeflow TFX components.
...
import logging
import sys
from tfx.orchestration.kubeflow import component_wrappers as wrappers
...
def main():
  ...
  subparser.add_argument('--schema', type=str, required=True)
  subparser.set_defaults(component=wrappers.TrainerWrapper)
  ...
  subparser.set_defaults(component=wrappers.EvaluatorWrapper)

  subparser = subparsers.add_parser('ModelValidator')
  subparser.add_argument('--examples', type=str, required=True)
  subparser.add_argument('--model', type=str, required=True)
  subparser.set_defaults(component=wrappers.ModelValidatorWrapper)
  ...
  subparser.set_defaults(component=wrappers.PusherWrapper)
