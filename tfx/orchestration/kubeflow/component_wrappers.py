...
"""Wrappers for TFX components running as part of a Kubeflow pipeline."""
...
class KubeflowComponentWrapper(utils.with_metaclass(abc.ABCMeta), object):
...
class CsvExampleGenWrapper(KubeflowComponentWrapper):
...
class BigQueryExampleGenWrapper(KubeflowComponentWrapper):
...
class StatisticsGenWrapper(KubeflowComponentWrapper):
...
class SchemaGenWrapper(KubeflowComponentWrapper):
...
class ExampleValidatorWrapper(KubeflowComponentWrapper):
...
class TransformWrapper(KubeflowComponentWrapper):
...
class TrainerWrapper(KubeflowComponentWrapper):
...
class EvaluatorWrapper(KubeflowComponentWrapper):
...
class ModelValidatorWrapper(KubeflowComponentWrapper):
...
class PusherWrapper(KubeflowComponentWrapper):
